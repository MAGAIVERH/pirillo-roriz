          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs leading-5 text-amber-200/80">
                Aqui o professor vai lançar presenças, acompanhar turmas, marcar
                alunos aptos para graduar e usar o leitor de QR Code. Quando
                seu acesso for criado pelo admin, você receberá um email com
                login e senha provisória.
              </p>
            </div>
          </div>
        </div>
