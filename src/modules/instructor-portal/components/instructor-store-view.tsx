...
import { createInstructorStoreReservationAction } from '@/modules/instructor-portal/actions/create-instructor-store-reservation';
import { InstructorStoreProductDetailModal } from '@/modules/instructor-portal/components/instructor-store-product-detail-modal';
import type { InstructorStoreReservationItem } from '@/modules/instructor-portal/queries/get-instructor-store-reservations';
...
type InstructorStoreViewProps = {
  products: StoreCatalogItem[];
  reservations: InstructorStoreReservationItem[];
};
...
export function InstructorStoreView({
  ...
  const handleReserve = (productId: string) => {
    ...
    startTransition(async () => {
      const result = await createInstructorStoreReservationAction({
        productId,
        quantity: 1,
      });
